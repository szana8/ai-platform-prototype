...
<template>
    ...
    <nav class="flex-1 text-center space-x-6">
        <NuxtLink to="#"
            class="text-gray-900 dark:text-gray-100 dark:hover:text-gray-100 dark:hover:border-gray-100 font-semibold hover:text-black hover:border-b-2 hover:border-gray-900 py-2">
            About</NuxtLink>
        <NuxtLink to="#"
            class="text-gray-900 dark:text-gray-100 dark:hover:text-gray-100 dark:hover:border-gray-100 font-semibold hover:text-black hover:border-b-2 hover:border-gray-900 py-2">
            Solutions</NuxtLink>
